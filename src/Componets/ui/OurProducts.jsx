...
const OurProducts = () => {
  ...
  const categories = ['ALL', 'FOOD & DRINKS', 'VEGETABLES', 'DRIED FOODS', 'BREAD & CAKE', 'FISH & MEAT'];

  // Mock data structure
  const products = [
    { id: 1, category: 'FOOD & DRINKS', title: 'Carrot Group Seal', price: '$32.20', oldPrice: '$46.00', discount: '-19%', img: img1 },
    { id: 2, category: 'VEGETABLES', title: 'Red Hot Tomato', price: '$32.20', oldPrice: '$46.00', discount: '-19%', img: img2 },
    { id: 3, category: 'FOOD & DRINKS', title: 'Orange Fresh Juice', price: '$32.20', oldPrice: '$46.00', discount: '-19%', img: img3 },
    { id: 4, category: 'FISH & MEAT', title: 'Poultry Farm Meat', price: '$32.20', oldPrice: '$46.00', discount: '-19%', img: img4 },
    { id: 5, category: 'BREAD & CAKE', title: 'Fresh Butter Cake', price: '$32.20', oldPrice: '$46.00', discount: '-19%', img: img5 },
    { id: 6, category: 'DRIED FOODS', title: 'Orange Sliced Mix', price: '$32.20', oldPrice: '$46.00', discount: '-19%', img: img6 },
    { id: 7, category: 'FOOD & DRINKS', title: 'Orange Fresh Juice', price: '$32.20', oldPrice: '$46.00', discount: '-19%', img: img7 },
    { id: 8, category: 'FOOD & DRINKS', title: 'Carrot Group Seal', price: '$32.20', oldPrice: '$46.00', discount: '-19%', img: img8 }
  ];
          ...
          {categories.map((tab, idx) => (
            <button
              ...
              className={`pb-2 relative cursor-pointer duration-300 uppercase ${
                activeTab === tab ? 'text-brand' : 'text-gray-400 hover:text-prim'
              }`}
            >
              {tab}
              {activeTab === tab && (
          ...
          {filteredProducts.map((product) => (
            ...
            >
              ...
              <div className="w-full aspect-square bg-[#F9F9F9] flex items-center justify-center p-4 relative overflow-hidden">
                ...
                {/* Badge layout */}
                <span className="absolute top-6 left-5 bg-brand text-white text-xs font-bold px-4 py-0.5 rounded-full font-prim">
                  {product.discount}
                </span>
              ...
              <div className="p-4 flex flex-col items-center text-center space-y-1.5">
                ...
                <div className="flex items-center gap-2 font-prim text-sm">
                  ...
                  <span className="text-gray-300 line-through">{product.oldPrice}</span>
                </div>
              </div>
